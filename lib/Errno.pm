...
"MSWin32-x64-multi-thread-10.0.20348.1906" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.20348.1906) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAENOTSOCK WSAESOCKTNOSUPPORT WSAETIMEDOUT WSAEINPROGRESS
	WSAEAFNOSUPPORT WSAEALREADY WSAEDISCON WSAEMFILE WSAENETUNREACH
	WSAEBADF WSAEREMOTE WSAEOPNOTSUPP WSAESTALE WSAENOMORE WSAEPROCLIM
	WSAENOTCONN WSAEPROTOTYPE WSAEINVALIDPROVIDER WSAECONNREFUSED
	WSAENAMETOOLONG WSAEPROVIDERFAILEDINIT WSAETOOMANYREFS WSAEUSERS
	WSAENOTEMPTY WSAEINVALIDPROCTABLE WSAEHOSTUNREACH WSAEPROTONOSUPPORT
	WSAEHOSTDOWN WSAEREFUSED WSAEADDRNOTAVAIL WSAELOOP WSAECANCELLED
	WSAEINVAL WSAEMSGSIZE WSAENOPROTOOPT WSAECONNRESET WSAEISCONN
	WSAEDQUOT WSAESHUTDOWN WSAENOBUFS WSAEWOULDBLOCK WSAEFAULT
	WSAEDESTADDRREQ WSAEADDRINUSE WSAEINTR WSAEPFNOSUPPORT WSAEACCES
	WSAENETRESET WSAECONNABORTED WSAENETDOWN
    )],
);
