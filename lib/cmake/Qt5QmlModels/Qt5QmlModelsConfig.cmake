...
set(Qt5QmlModels_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/include/qt5/QtQmlModels/5.15.10"
        "${_qt5QmlModels_install_prefix}/include/qt5/QtQmlModels/5.15.10/QtQmlModels"
    )
    ...
    foreach(_module_dep ${_Qt5QmlModels_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QmlModels_FIND_VERSION_EXACT}
    ...
    _populate_QmlModels_target_properties(RELEASE "Qt5QmlModels.dll" "libQt5QmlModels.a" FALSE)

    if (EXISTS
        "${_qt5QmlModels_install_prefix}/bin/Qt5QmlModels.dll"
      AND EXISTS
        "${_qt5QmlModels_install_prefix}/lib/libQt5QmlModels.a" )
        _populate_QmlModels_target_properties(DEBUG "Qt5QmlModels.dll" "libQt5QmlModels.a" FALSE)
    endif()
