...
set(Qt5Multimedia_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/qt5/QtMultimedia/5.15.10"
        "${_qt5Multimedia_install_prefix}/include/qt5/QtMultimedia/5.15.10/QtMultimedia"
    )
    ...
    foreach(_module_dep ${_Qt5Multimedia_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Multimedia_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Multimedia
                 ...
                 directshow;evr;wmf;wmsdk;wshellitem)
    set_property(TARGET Qt5::Multimedia
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 alsa;gpu_vivante;gstreamer;gstreamer_0_10;gstreamer_1_0;gstreamer_app;gstreamer_encodingprofiles;gstreamer_gl;gstreamer_photography;linux_v4l;openal;pulseaudio;resourcepolicy;wasapi)
    ...
    _populate_Multimedia_target_properties(RELEASE "Qt5Multimedia.dll" "libQt5Multimedia.a" FALSE)

    if (EXISTS
        "${_qt5Multimedia_install_prefix}/bin/Qt5Multimedia.dll"
      AND EXISTS
        "${_qt5Multimedia_install_prefix}/lib/libQt5Multimedia.a" )
        _populate_Multimedia_target_properties(DEBUG "Qt5Multimedia.dll" "libQt5Multimedia.a" FALSE)
    endif()
