...
set(Qt5Svg_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/qt5/QtSvg/5.15.10"
        "${_qt5Svg_install_prefix}/include/qt5/QtSvg/5.15.10/QtSvg"
    )
    ...
    foreach(_module_dep ${_Qt5Svg_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Svg_FIND_VERSION_EXACT}
    ...
    _populate_Svg_target_properties(RELEASE "Qt5Svg.dll" "libQt5Svg.a" FALSE)

    if (EXISTS
        "${_qt5Svg_install_prefix}/bin/Qt5Svg.dll"
      AND EXISTS
        "${_qt5Svg_install_prefix}/lib/libQt5Svg.a" )
        _populate_Svg_target_properties(DEBUG "Qt5Svg.dll" "libQt5Svg.a" FALSE)
    endif()
