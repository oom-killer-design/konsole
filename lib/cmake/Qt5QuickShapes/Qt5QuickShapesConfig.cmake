...
set(Qt5QuickShapes_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.10"
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.10/QtQuickShapes"
    )
    ...
    foreach(_module_dep ${_Qt5QuickShapes_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QuickShapes_FIND_VERSION_EXACT}
    ...
    _populate_QuickShapes_target_properties(RELEASE "Qt5QuickShapes.dll" "libQt5QuickShapes.a" FALSE)

    if (EXISTS
        "${_qt5QuickShapes_install_prefix}/bin/Qt5QuickShapes.dll"
      AND EXISTS
        "${_qt5QuickShapes_install_prefix}/lib/libQt5QuickShapes.a" )
        _populate_QuickShapes_target_properties(DEBUG "Qt5QuickShapes.dll" "libQt5QuickShapes.a" FALSE)
    endif()
