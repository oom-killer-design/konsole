...
set(Qt5PrintSupport_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/qt5/QtPrintSupport/5.15.10"
        "${_qt5PrintSupport_install_prefix}/include/qt5/QtPrintSupport/5.15.10/QtPrintSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PrintSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5PrintSupport_FIND_VERSION_EXACT}
    ...
    _populate_PrintSupport_target_properties(RELEASE "Qt5PrintSupport.dll" "libQt5PrintSupport.a" FALSE)

    if (EXISTS
        "${_qt5PrintSupport_install_prefix}/bin/Qt5PrintSupport.dll"
      AND EXISTS
        "${_qt5PrintSupport_install_prefix}/lib/libQt5PrintSupport.a" )
        _populate_PrintSupport_target_properties(DEBUG "Qt5PrintSupport.dll" "libQt5PrintSupport.a" FALSE)
    endif()
