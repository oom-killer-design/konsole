...
set(Qt5TextToSpeech_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    set(Qt5TextToSpeech_PRIVATE_INCLUDE_DIRS
        "${_qt5TextToSpeech_install_prefix}/include/qt5/QtTextToSpeech/5.15.10"
        "${_qt5TextToSpeech_install_prefix}/include/qt5/QtTextToSpeech/5.15.10/QtTextToSpeech"
    )
    ...
    foreach(_module_dep ${_Qt5TextToSpeech_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5TextToSpeech_FIND_VERSION_EXACT}
    ...
    _populate_TextToSpeech_target_properties(RELEASE "Qt5TextToSpeech.dll" "libQt5TextToSpeech.a" FALSE)

    if (EXISTS
        "${_qt5TextToSpeech_install_prefix}/bin/Qt5TextToSpeech.dll"
      AND EXISTS
        "${_qt5TextToSpeech_install_prefix}/lib/libQt5TextToSpeech.a" )
        _populate_TextToSpeech_target_properties(DEBUG "Qt5TextToSpeech.dll" "libQt5TextToSpeech.a" FALSE)
    endif()
