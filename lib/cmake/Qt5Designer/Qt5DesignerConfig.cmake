...
set(Qt5Designer_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Designer)
    ...
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/qt5/QtDesigner/5.15.10"
        "${_qt5Designer_install_prefix}/include/qt5/QtDesigner/5.15.10/QtDesigner"
    )
    ...
    foreach(_module_dep ${_Qt5Designer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Designer_FIND_VERSION_EXACT}
    ...
    _populate_Designer_target_properties(RELEASE "Qt5Designer.dll" "libQt5Designer.a" FALSE)

    if (EXISTS
        "${_qt5Designer_install_prefix}/bin/Qt5Designer.dll"
      AND EXISTS
        "${_qt5Designer_install_prefix}/lib/libQt5Designer.a" )
        _populate_Designer_target_properties(DEBUG "Qt5Designer.dll" "libQt5Designer.a" FALSE)
    endif()
