...
set(Qt5DBus_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.15.10"
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.15.10/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    _populate_DBus_target_properties(RELEASE "Qt5DBus.dll" "libQt5DBus.a" FALSE)

    if (EXISTS
        "${_qt5DBus_install_prefix}/bin/Qt5DBus.dll"
      AND EXISTS
        "${_qt5DBus_install_prefix}/lib/libQt5DBus.a" )
        _populate_DBus_target_properties(DEBUG "Qt5DBus.dll" "libQt5DBus.a" FALSE)
    endif()
