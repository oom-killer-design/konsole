...
set(Qt5MultimediaWidgets_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/qt5/QtMultimediaWidgets/5.15.10"
        "${_qt5MultimediaWidgets_install_prefix}/include/qt5/QtMultimediaWidgets/5.15.10/QtMultimediaWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5MultimediaWidgets_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "Qt5MultimediaWidgets.dll" "libQt5MultimediaWidgets.a" FALSE)

    if (EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/bin/Qt5MultimediaWidgets.dll"
      AND EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/lib/libQt5MultimediaWidgets.a" )
        _populate_MultimediaWidgets_target_properties(DEBUG "Qt5MultimediaWidgets.dll" "libQt5MultimediaWidgets.a" FALSE)
    endif()
