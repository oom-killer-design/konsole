...
set(Qt5QuickControls2_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.15.10"
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.15.10/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    _populate_QuickControls2_target_properties(RELEASE "Qt5QuickControls2.dll" "libQt5QuickControls2.a" FALSE)

    if (EXISTS
        "${_qt5QuickControls2_install_prefix}/bin/Qt5QuickControls2.dll"
      AND EXISTS
        "${_qt5QuickControls2_install_prefix}/lib/libQt5QuickControls2.a" )
        _populate_QuickControls2_target_properties(DEBUG "Qt5QuickControls2.dll" "libQt5QuickControls2.a" FALSE)
    endif()
