...
set(Qt5QuickWidgets_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/qt5/QtQuickWidgets/5.15.10"
        "${_qt5QuickWidgets_install_prefix}/include/qt5/QtQuickWidgets/5.15.10/QtQuickWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5QuickWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QuickWidgets_FIND_VERSION_EXACT}
    ...
    _populate_QuickWidgets_target_properties(RELEASE "Qt5QuickWidgets.dll" "libQt5QuickWidgets.a" FALSE)

    if (EXISTS
        "${_qt5QuickWidgets_install_prefix}/bin/Qt5QuickWidgets.dll"
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/lib/libQt5QuickWidgets.a" )
        _populate_QuickWidgets_target_properties(DEBUG "Qt5QuickWidgets.dll" "libQt5QuickWidgets.a" FALSE)
    endif()
