...
set(Qt5UiTools_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/qt5/QtUiTools/5.15.10"
        "${_qt5UiTools_install_prefix}/include/qt5/QtUiTools/5.15.10/QtUiTools"
    )
    ...
    foreach(_module_dep ${_Qt5UiTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5UiTools_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5UiTools_install_prefix}/lib/libQt5UiTools.a" )
        _populate_UiTools_target_properties(DEBUG "libQt5UiTools.a" "" FALSE)
    endif()
