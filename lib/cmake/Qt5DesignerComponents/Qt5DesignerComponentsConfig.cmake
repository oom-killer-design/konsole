...
set(Qt5DesignerComponents_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    set(Qt5DesignerComponents_PRIVATE_INCLUDE_DIRS
        "${_qt5DesignerComponents_install_prefix}/include/qt5/QtDesignerComponents/5.15.10"
        "${_qt5DesignerComponents_install_prefix}/include/qt5/QtDesignerComponents/5.15.10/QtDesignerComponents"
    )
    ...
    foreach(_module_dep ${_Qt5DesignerComponents_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5DesignerComponents_FIND_VERSION_EXACT}
    ...
    _populate_DesignerComponents_target_properties(RELEASE "Qt5DesignerComponents.dll" "libQt5DesignerComponents.a" FALSE)

    if (EXISTS
        "${_qt5DesignerComponents_install_prefix}/bin/Qt5DesignerComponents.dll"
      AND EXISTS
        "${_qt5DesignerComponents_install_prefix}/lib/libQt5DesignerComponents.a" )
        _populate_DesignerComponents_target_properties(DEBUG "Qt5DesignerComponents.dll" "libQt5DesignerComponents.a" FALSE)
    endif()
