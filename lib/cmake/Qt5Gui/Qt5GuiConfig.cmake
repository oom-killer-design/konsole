...
set(Qt5Gui_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.10"
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.10/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 dxguid;direct3d9;angle_d3d11_qdtd;dxgi;direct3d11;direct2d;direct2d1_1;dxgi1_2;direct3d11_1;directwrite;directwrite1;directwrite2;egl;freetype;system-freetype;gif;harfbuzz;ico;imageio-text-loading;jpeg;multiprocess;png;raster-64bit;system-harfbuzz;system-jpeg;system-png;tuiotouch;vkgen)
    set_property(TARGET Qt5::Gui
