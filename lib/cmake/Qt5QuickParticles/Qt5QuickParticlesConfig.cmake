...
set(Qt5QuickParticles_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    set(Qt5QuickParticles_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickParticles_install_prefix}/include/qt5/QtQuickParticles/5.15.10"
        "${_qt5QuickParticles_install_prefix}/include/qt5/QtQuickParticles/5.15.10/QtQuickParticles"
    )
    ...
    foreach(_module_dep ${_Qt5QuickParticles_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QuickParticles_FIND_VERSION_EXACT}
    ...
    _populate_QuickParticles_target_properties(RELEASE "Qt5QuickParticles.dll" "libQt5QuickParticles.a" FALSE)

    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/bin/Qt5QuickParticles.dll"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/lib/libQt5QuickParticles.a" )
        _populate_QuickParticles_target_properties(DEBUG "Qt5QuickParticles.dll" "libQt5QuickParticles.a" FALSE)
    endif()
