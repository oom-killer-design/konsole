...
set(Qt5Widgets_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/qt5/QtWidgets/5.15.10"
        "${_qt5Widgets_install_prefix}/include/qt5/QtWidgets/5.15.10/QtWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    _populate_Widgets_target_properties(RELEASE "Qt5Widgets.dll" "libQt5Widgets.a" FALSE)

    if (EXISTS
        "${_qt5Widgets_install_prefix}/bin/Qt5Widgets.dll"
      AND EXISTS
        "${_qt5Widgets_install_prefix}/lib/libQt5Widgets.a" )
        _populate_Widgets_target_properties(DEBUG "Qt5Widgets.dll" "libQt5Widgets.a" FALSE)
    endif()
