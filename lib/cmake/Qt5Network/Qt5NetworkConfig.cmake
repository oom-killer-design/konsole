...
set(Qt5Network_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.15.10"
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.15.10/QtNetwork"
    )
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Network_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Network
                 ...
                 openssl-linked;openssl;system-proxies)
    set_property(TARGET Qt5::Network
    ...
    _populate_Network_target_properties(RELEASE "Qt5Network.dll" "libQt5Network.a" FALSE)

    if (EXISTS
        "${_qt5Network_install_prefix}/bin/Qt5Network.dll"
      AND EXISTS
        "${_qt5Network_install_prefix}/lib/libQt5Network.a" )
        _populate_Network_target_properties(DEBUG "Qt5Network.dll" "libQt5Network.a" FALSE)
    endif()
