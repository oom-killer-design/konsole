...
set(Qt5Xml_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/qt5/QtXml/5.15.10"
        "${_qt5Xml_install_prefix}/include/qt5/QtXml/5.15.10/QtXml"
    )
    ...
    foreach(_module_dep ${_Qt5Xml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Xml_FIND_VERSION_EXACT}
    ...
    _populate_Xml_target_properties(RELEASE "Qt5Xml.dll" "libQt5Xml.a" FALSE)

    if (EXISTS
        "${_qt5Xml_install_prefix}/bin/Qt5Xml.dll"
      AND EXISTS
        "${_qt5Xml_install_prefix}/lib/libQt5Xml.a" )
        _populate_Xml_target_properties(DEBUG "Qt5Xml.dll" "libQt5Xml.a" FALSE)
    endif()
