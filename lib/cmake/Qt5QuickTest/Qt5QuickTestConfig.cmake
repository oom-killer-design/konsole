...
set(Qt5QuickTest_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.15.10"
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.15.10/QtQuickTest"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTest_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QuickTest_FIND_VERSION_EXACT}
    ...
    _populate_QuickTest_target_properties(RELEASE "Qt5QuickTest.dll" "libQt5QuickTest.a" FALSE)

    if (EXISTS
        "${_qt5QuickTest_install_prefix}/bin/Qt5QuickTest.dll"
      AND EXISTS
        "${_qt5QuickTest_install_prefix}/lib/libQt5QuickTest.a" )
        _populate_QuickTest_target_properties(DEBUG "Qt5QuickTest.dll" "libQt5QuickTest.a" FALSE)
    endif()
