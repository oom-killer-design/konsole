...
set(Qt5WinExtras_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::WinExtras)
    ...
    set(_Qt5WinExtras_OWN_INCLUDE_DIRS "${_qt5WinExtras_install_prefix}/include/qt5/" "${_qt5WinExtras_install_prefix}/include/qt5/QtWinExtras")
    set(Qt5WinExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5WinExtras_install_prefix}/include/qt5/QtWinExtras/5.15.10"
        "${_qt5WinExtras_install_prefix}/include/qt5/QtWinExtras/5.15.10/QtWinExtras"
    )
    ...
    foreach(_module_dep ${_Qt5WinExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5WinExtras_FIND_VERSION_EXACT}
    ...
    _populate_WinExtras_target_properties(RELEASE "Qt5WinExtras.dll" "libQt5WinExtras.a" FALSE)

    if (EXISTS
        "${_qt5WinExtras_install_prefix}/bin/Qt5WinExtras.dll"
      AND EXISTS
        "${_qt5WinExtras_install_prefix}/lib/libQt5WinExtras.a" )
        _populate_WinExtras_target_properties(DEBUG "Qt5WinExtras.dll" "libQt5WinExtras.a" FALSE)
    endif()
