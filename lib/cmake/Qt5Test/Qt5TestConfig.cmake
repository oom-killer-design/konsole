...
set(Qt5Test_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.15.10"
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.15.10/QtTest"
    )
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "Qt5Test.dll" "libQt5Test.a" FALSE)

    if (EXISTS
        "${_qt5Test_install_prefix}/bin/Qt5Test.dll"
      AND EXISTS
        "${_qt5Test_install_prefix}/lib/libQt5Test.a" )
        _populate_Test_target_properties(DEBUG "Qt5Test.dll" "libQt5Test.a" FALSE)
    endif()
