...
set(Qt5QmlWorkerScript_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.10"
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.10/QtQmlWorkerScript"
    )
    ...
    foreach(_module_dep ${_Qt5QmlWorkerScript_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QmlWorkerScript_FIND_VERSION_EXACT}
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "Qt5QmlWorkerScript.dll" "libQt5QmlWorkerScript.a" FALSE)

    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/bin/Qt5QmlWorkerScript.dll"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/lib/libQt5QmlWorkerScript.a" )
        _populate_QmlWorkerScript_target_properties(DEBUG "Qt5QmlWorkerScript.dll" "libQt5QmlWorkerScript.a" FALSE)
    endif()
