...
set(Qt5Quick_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.15.10"
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.15.10/QtQuick"
    )
    ...
    foreach(_module_dep ${_Qt5Quick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Quick_FIND_VERSION_EXACT}
    ...
    _populate_Quick_target_properties(RELEASE "Qt5Quick.dll" "libQt5Quick.a" FALSE)

    if (EXISTS
        "${_qt5Quick_install_prefix}/bin/Qt5Quick.dll"
      AND EXISTS
        "${_qt5Quick_install_prefix}/lib/libQt5Quick.a" )
        _populate_Quick_target_properties(DEBUG "Qt5Quick.dll" "libQt5Quick.a" FALSE)
    endif()
