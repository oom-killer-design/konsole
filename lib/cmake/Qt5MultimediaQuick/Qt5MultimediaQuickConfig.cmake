...
set(Qt5MultimediaQuick_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::MultimediaQuick)
    ...
    set(Qt5MultimediaQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaQuick_install_prefix}/include/qt5/QtMultimediaQuick/5.15.10"
        "${_qt5MultimediaQuick_install_prefix}/include/qt5/QtMultimediaQuick/5.15.10/QtMultimediaQuick"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5MultimediaQuick_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaQuick_target_properties(RELEASE "Qt5MultimediaQuick.dll" "libQt5MultimediaQuick.a" FALSE)

    if (EXISTS
        "${_qt5MultimediaQuick_install_prefix}/bin/Qt5MultimediaQuick.dll"
      AND EXISTS
        "${_qt5MultimediaQuick_install_prefix}/lib/libQt5MultimediaQuick.a" )
        _populate_MultimediaQuick_target_properties(DEBUG "Qt5MultimediaQuick.dll" "libQt5MultimediaQuick.a" FALSE)
    endif()
