...
set(Qt5QmlDevTools_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/qt5/QtQml/5.15.10"
        "${_qt5QmlDevTools_install_prefix}/include/qt5/QtQml/5.15.10/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5QmlDevTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QmlDevTools_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5QmlDevTools_install_prefix}/lib/libQt5QmlDevTools.a" )
        _populate_QmlDevTools_target_properties(DEBUG "libQt5QmlDevTools.a" "" FALSE)
    endif()
