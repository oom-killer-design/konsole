...
set(Qt5QuickTemplates2_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/qt5/QtQuickTemplates2/5.15.10"
        "${_qt5QuickTemplates2_install_prefix}/include/qt5/QtQuickTemplates2/5.15.10/QtQuickTemplates2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "Qt5QuickTemplates2.dll" "libQt5QuickTemplates2.a" FALSE)

    if (EXISTS
        "${_qt5QuickTemplates2_install_prefix}/bin/Qt5QuickTemplates2.dll"
      AND EXISTS
        "${_qt5QuickTemplates2_install_prefix}/lib/libQt5QuickTemplates2.a" )
        _populate_QuickTemplates2_target_properties(DEBUG "Qt5QuickTemplates2.dll" "libQt5QuickTemplates2.a" FALSE)
    endif()
