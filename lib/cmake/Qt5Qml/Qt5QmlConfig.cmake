...
set(Qt5Qml_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/qt5/QtQml/5.15.10"
        "${_qt5Qml_install_prefix}/include/qt5/QtQml/5.15.10/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    _populate_Qml_target_properties(RELEASE "Qt5Qml.dll" "libQt5Qml.a" FALSE)

    if (EXISTS
        "${_qt5Qml_install_prefix}/bin/Qt5Qml.dll"
      AND EXISTS
        "${_qt5Qml_install_prefix}/lib/libQt5Qml.a" )
        _populate_Qml_target_properties(DEBUG "Qt5Qml.dll" "libQt5Qml.a" FALSE)
    endif()
