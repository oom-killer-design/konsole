...
set(Qt5OpenGL_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.15.10"
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.15.10/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "Qt5OpenGL.dll" "libQt5OpenGL.a" FALSE)

    if (EXISTS
        "${_qt5OpenGL_install_prefix}/bin/Qt5OpenGL.dll"
      AND EXISTS
        "${_qt5OpenGL_install_prefix}/lib/libQt5OpenGL.a" )
        _populate_OpenGL_target_properties(DEBUG "Qt5OpenGL.dll" "libQt5OpenGL.a" FALSE)
    endif()
