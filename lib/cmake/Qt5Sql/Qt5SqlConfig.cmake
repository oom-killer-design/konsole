...
set(Qt5Sql_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/qt5/QtSql/5.15.10"
        "${_qt5Sql_install_prefix}/include/qt5/QtSql/5.15.10/QtSql"
    )
    ...
    foreach(_module_dep ${_Qt5Sql_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Sql_FIND_VERSION_EXACT}
    ...
    _populate_Sql_target_properties(RELEASE "Qt5Sql.dll" "libQt5Sql.a" FALSE)

    if (EXISTS
        "${_qt5Sql_install_prefix}/bin/Qt5Sql.dll"
      AND EXISTS
        "${_qt5Sql_install_prefix}/lib/libQt5Sql.a" )
        _populate_Sql_target_properties(DEBUG "Qt5Sql.dll" "libQt5Sql.a" FALSE)
    endif()
