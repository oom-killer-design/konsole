...
set(Qt5EglSupport_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::EglSupport)
    ...
    set(_Qt5EglSupport_OWN_INCLUDE_DIRS "${_qt5EglSupport_install_prefix}/include/qt5/" "${_qt5EglSupport_install_prefix}/include/qt5/QtEglSupport")
    set(Qt5EglSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EglSupport_install_prefix}/include/qt5/QtEglSupport/5.15.10"
        "${_qt5EglSupport_install_prefix}/include/qt5/QtEglSupport/5.15.10/QtEglSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EglSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5EglSupport_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5EglSupport_install_prefix}/lib/libQt5EglSupport.a" )
        _populate_EglSupport_target_properties(DEBUG "libQt5EglSupport.a" "" FALSE)
    endif()
