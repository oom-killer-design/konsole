...
set(Qt5Concurrent_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Concurrent)
    ...
    foreach(_module_dep ${_Qt5Concurrent_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Concurrent_FIND_VERSION_EXACT}
    ...
    _populate_Concurrent_target_properties(RELEASE "Qt5Concurrent.dll" "libQt5Concurrent.a" FALSE)

    if (EXISTS
        "${_qt5Concurrent_install_prefix}/bin/Qt5Concurrent.dll"
      AND EXISTS
        "${_qt5Concurrent_install_prefix}/lib/libQt5Concurrent.a" )
        _populate_Concurrent_target_properties(DEBUG "Qt5Concurrent.dll" "libQt5Concurrent.a" FALSE)
    endif()
