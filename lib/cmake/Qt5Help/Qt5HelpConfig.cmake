...
set(Qt5Help_VERSION_STRING 5.15.10)
...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/qt5/QtHelp/5.15.10"
        "${_qt5Help_install_prefix}/include/qt5/QtHelp/5.15.10/QtHelp"
    )
    ...
    foreach(_module_dep ${_Qt5Help_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.10 ${_Qt5Help_FIND_VERSION_EXACT}
    ...
    _populate_Help_target_properties(RELEASE "Qt5Help.dll" "libQt5Help.a" FALSE)

    if (EXISTS
        "${_qt5Help_install_prefix}/bin/Qt5Help.dll"
      AND EXISTS
        "${_qt5Help_install_prefix}/lib/libQt5Help.a" )
        _populate_Help_target_properties(DEBUG "Qt5Help.dll" "libQt5Help.a" FALSE)
    endif()
